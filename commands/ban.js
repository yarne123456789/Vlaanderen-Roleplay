...
module.exports.run = async (client, message, args) => {
    if (!message.member.permissions.has('BAN_MEMBERS')) return message.reply('Je hebt geen permissie om dit commando uit te voeren!');

    if (!message.guild.me.permissions.has('BAN_MEMBERS')) return message.reply('Ik heb geen permissie om mensen te kicken.');
    ...
    if (!banUser) return message.reply('Ik kan het opgegeven member niet vinden.');
